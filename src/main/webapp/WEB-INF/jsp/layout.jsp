...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/theme/plugins/select2/select2.min.css">
      <!-- Theme style -->
      ...
      <!-- Select2 -->
      <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/theme/application.css">
   ...
   <body class="hold-transition skin-blue sidebar-mini">
      ...
      <!-- Select2 -->
      <script src="${pageContext.request.contextPath}/resources/theme/plugins/select2/select2.full.min.js"></script>
      <!-- daterangepicker -->
      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            <div class="container">
               <div class="alert row invisible devnotification fixedElement"  >
                  <div class="col-md-12">
      ...
      <script src="${pageContext.request.contextPath}/resources/devjs/application.js"></script>
   </body>
</html>