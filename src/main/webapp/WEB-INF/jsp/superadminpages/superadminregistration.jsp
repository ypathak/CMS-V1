         ...
         <div class="box">
            <div class="box-header">
               ...
               <a href="javascript:void(0)"
                  ...
                  style="float: right;" onclick="superadmin.addnewadminbtn()"><i class="fa fa-fw fa-plus-circle"></i> Add New
               Admin</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="dataTables_length" id="example2_length">
                           <label>
                              Show 
                              <select name="example2_length" aria-controls="example2" class="form-control input-sm" id="showdatalength" onchange="superadmin.getadmindata(1);">
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <table id="example2"
                           ...
                           <tbody>
                              <c:if test="${not empty adminlistdata}">
                                 <c:set var="userFormlist" value="${adminlistdata.data }"></c:set>
                              </c:if>
                              <c:forEach items="${userFormlist}" var="userForm">
                                 <tr role="row">
                                    <td>
                                    ...
                                    <td>
                                       <c:out value="${userForm.aadharnum}" />
                                    </td>
                                    <td>Delete</td>
                                    <td>Edit</td>
                                 </tr>
                  ...
                  <div class="row">
                     <div class="col-sm-5">
                        <div class="dataTables_info" id="example2_info" role="status"
                           aria-live="polite">Showing 1 to ${ adminlistdata.totalrecperpage} of ${ adminlistdata.totalrec}entries</div>
                     </div>
                     <div class="col-sm-7">
                        <div class="dataTables_paginate paging_simple_numbers"
                           ...
                           <ul class="pagination">
                              ...
                              <c:forEach var="i" begin="1" end="${adminlistdata.totalpage}">
                                 <c:if test="${i==1 }">
                                    <li class= "paginate_button active" id="page${i }">
                                       <a href="#"
                                          aria-controls="example2" data-dt-idx="1" tabindex="0" onclick="superadmin.getadmindata(${i})">
                                          <c:out value="${i}"/>
                                       </a>
                                    </li>
                                 </c:if>
                                 <c:if test="${i!=1 }">
                                    <li class= "paginate_button" id="page${i }">
                                       <a href="#"
                                          aria-controls="example2" data-dt-idx="1" tabindex="0" onclick="superadmin.getadmindata(${i})">
                                          <c:out value="${i}"/>
                                       </a>
...
<section class="content" id="adminRegDiv">
   <div class="box box-default">
      <div class="box-header with-border">
         ...
         <a href="javascript:void(0)" class="btn btn-sm btn-warning btn-flat pull-right" onclick="superadmin.backadminlistbtn()"><i class="fa fa-fw fa-arrow-circle-left"></i> Back 
         </a>
