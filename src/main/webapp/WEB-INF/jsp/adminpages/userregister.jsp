   ...
   <section class="content" id="adminRegDiv">
      <div class="box box-default">
         ...
         <div class="box-body">
            ...
            <form:form modelAttribute="Empdata" name="dev_adminRegistrationForm" action="javascript:void(0);">
               <div class="row">
                  <div class="col-md-6">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group has-feedback ${status.error ? 'has-error' : ''}">
                        <div class="form-group">
                           ...
                           <form:select class="form-control select2" style="width: 100%;" path="homecountryid" onchange="admin.homeCountryDrpChange();">
                  ...
                  <div class="col-md-6">
                     <div class="form-group has-feedback dev_homestates ${status.error ? 'has-error' : ''}">
                        ...
                        <form:select class="form-control select2" style="width: 100%;" path="homestateid" onchange="admin.homeStateDrpChange();">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group has-feedback ${status.error ? 'has-error' : ''}">
                        <div class="form-group">
                           <label  class="requiredField">Country</label>
                           <form:select class="form-control select2" style="width: 100%;" path="officecountryid" onchange="admin.offCountryDrpChange();">
                  ...
                  <div class="col-md-6">
                     <div class="form-group has-feedback dev_officestateid ${status.error ? 'has-error' : ''}">
                        <label  class="requiredField">State</label>
                        <form:select class="form-control select2" style="width: 100%;" path="officestateid" onchange="admin.offStateDrpChange();">
               ...
               <div class="box-footer">
                  ...
                  <button type="submit" class="btn btn-primary"
                        onclick="return admin.save();">Submit</button>
               </div>
            </form:form>
         </div>
      </div>
...
<script src="${contextPath}/resources/devjs/admin.js"></script>
